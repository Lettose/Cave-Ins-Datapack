execute as @s[tag=!build_support] if block ~ ~1 ~ #permeable run function cave_in:supports/destroy_support
...
execute as @s[tag=2_blocks_tall] if block ~ ~-2 ~ #permeable run function cave_in:supports/destroy_support
...
execute as @s[tag=3_blocks_tall] if block ~ ~-3 ~ #permeable run function cave_in:supports/destroy_support
...
execute as @s[tag=4_blocks_tall] if block ~ ~-4 ~ #permeable run function cave_in:supports/destroy_support
...
execute as @s[tag=5_blocks_tall] if block ~ ~-5 ~ #permeable run function cave_in:supports/destroy_support
...
execute as @s[tag=6_blocks_tall] if block ~ ~-6 ~ #permeable run function cave_in:supports/destroy_support
...
execute as @s[tag=7_blocks_tall] if block ~ ~-7 ~ #permeable run function cave_in:supports/destroy_support
...
execute as @s[tag=8_blocks_tall] if block ~ ~-8 ~ #permeable run function cave_in:supports/destroy_support
...
execute as @s[tag=9_blocks_tall] if block ~ ~-9 ~ #permeable run function cave_in:supports/destroy_support
...
execute as @s[tag=10_blocks_tall] if block ~ ~-10 ~ #permeable run function cave_in:supports/destroy_support
