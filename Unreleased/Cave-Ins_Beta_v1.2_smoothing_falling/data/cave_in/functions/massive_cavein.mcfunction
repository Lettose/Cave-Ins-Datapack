...
execute as @s[tag=massive_cave_in,scores={cave_in.tick=5}] positioned ~-1 ~-1 ~ if predicate cave_in:massive_severity_chance unless block ~ ~ ~ #permeable if block ~ ~-1 ~ #permeable run summon armor_stand ~ ~250 ~ {NoGravity:1b,Invulnerable:1b,Invisible:1b,Tags:["massive_additional_cave_in"]}
execute as @s[tag=massive_additional_cave_in,scores={cave_in.tick=5}] positioned ~-1 ~-1 ~ if predicate cave_in:massive_additional_severity_chance unless block ~ ~ ~ #permeable if block ~ ~-1 ~ #permeable run summon armor_stand ~ ~250 ~ {NoGravity:1b,Invulnerable:1b,Invisible:1b,Tags:["massive_additional_cave_in"]}
#execute as @s[scores={cave_in.tick=3}] if block ~-1 ~-2 ~ #permeable run function cave_in:replace_block/bottom_back

execute as @s[tag=massive_cave_in,scores={cave_in.tick=7}] positioned ~ ~-1 ~-1 if predicate cave_in:massive_severity_chance unless block ~ ~ ~ #permeable if block ~ ~-1 ~ #permeable run summon armor_stand ~ ~250 ~ {NoGravity:1b,Invulnerable:1b,Invisible:1b,Tags:["massive_additional_cave_in"]}
execute as @s[tag=massive_additional_cave_in,scores={cave_in.tick=7}] positioned ~ ~-1 ~-1 if predicate cave_in:massive_additional_severity_chance unless block ~ ~ ~ #permeable if block ~ ~-1 ~ #permeable run summon armor_stand ~ ~250 ~ {NoGravity:1b,Invulnerable:1b,Invisible:1b,Tags:["massive_additional_cave_in"]}
...
# Left
execute as @s[tag=massive_cave_in,scores={cave_in.tick=11}] positioned ~1 ~ ~ if predicate cave_in:massive_severity_chance unless block ~ ~ ~ #permeable if block ~ ~-1 ~ #permeable run summon armor_stand ~ ~250 ~ {NoGravity:1b,Invulnerable:1b,Invisible:1b,Tags:["massive_additional_cave_in"]}
execute as @s[tag=massive_additional_cave_in,scores={cave_in.tick=11}] positioned ~1 ~ ~ if predicate cave_in:massive_additional_severity_chance unless block ~ ~ ~ #permeable if block ~ ~-1 ~ #permeable run summon armor_stand ~ ~250 ~ {NoGravity:1b,Invulnerable:1b,Invisible:1b,Tags:["massive_additional_cave_in"]}
execute as @s[scores={cave_in.tick=11}] positioned ~1 ~ ~ if block ~ ~-1 ~ #permeable run function cave_in:replace_block

# Right
execute as @s[tag=massive_cave_in,scores={cave_in.tick=13}] positioned ~ ~ ~1 if predicate cave_in:massive_severity_chance unless block ~ ~ ~ #permeable if block ~ ~-1 ~ #permeable run summon armor_stand ~ ~250 ~ {NoGravity:1b,Invulnerable:1b,Invisible:1b,Tags:["massive_additional_cave_in"]}
execute as @s[tag=massive_additional_cave_in,scores={cave_in.tick=13}] positioned ~ ~ ~1 if predicate cave_in:massive_additional_severity_chance unless block ~ ~ ~ #permeable if block ~ ~-1 ~ #permeable run summon armor_stand ~ ~250 ~ {NoGravity:1b,Invulnerable:1b,Invisible:1b,Tags:["massive_additional_cave_in"]}
execute as @s[scores={cave_in.tick=13}] positioned ~ ~ ~1 if block ~ ~-1 ~ #permeable run function cave_in:replace_block

# Back
execute as @s[tag=massive_cave_in,scores={cave_in.tick=15}] positioned ~-1 ~ ~ if predicate cave_in:massive_severity_chance unless block ~ ~ ~ #permeable if block ~ ~-1 ~ #permeable run summon armor_stand ~ ~250 ~ {NoGravity:1b,Invulnerable:1b,Invisible:1b,Tags:["massive_additional_cave_in"]}
execute as @s[tag=massive_additional_cave_in,scores={cave_in.tick=15}] positioned ~-1 ~ ~ if predicate cave_in:massive_additional_severity_chance unless block ~ ~ ~ #permeable if block ~ ~-1 ~ #permeable run summon armor_stand ~ ~250 ~ {NoGravity:1b,Invulnerable:1b,Invisible:1b,Tags:["massive_additional_cave_in"]}
execute as @s[scores={cave_in.tick=15}] positioned ~-1 ~ ~ if block ~ ~-1 ~ #permeable run function cave_in:replace_block

# Front
execute as @s[tag=massive_cave_in,scores={cave_in.tick=17}] positioned ~ ~ ~-1 if predicate cave_in:massive_severity_chance unless block ~ ~ ~ #permeable if block ~ ~-1 ~ #permeable run summon armor_stand ~ ~250 ~ {NoGravity:1b,Invulnerable:1b,Invisible:1b,Tags:["massive_additional_cave_in"]}
execute as @s[tag=massive_additional_cave_in,scores={cave_in.tick=17}] positioned ~ ~ ~-1 if predicate cave_in:massive_additional_severity_chance unless block ~ ~ ~ #permeable if block ~ ~-1 ~ #permeable run summon armor_stand ~ ~250 ~ {NoGravity:1b,Invulnerable:1b,Invisible:1b,Tags:["massive_additional_cave_in"]}
