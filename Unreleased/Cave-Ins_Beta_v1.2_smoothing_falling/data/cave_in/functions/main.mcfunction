...
execute as @e[type=falling_block] unless entity @s[nbt={BlockState:{Name:"minecraft:sand"}}] unless entity @s[nbt={BlockState:{Name:"minecraft:red_sand"}}] unless entity @s[nbt={BlockState:{Name:"minecraft:gravel"}}] unless entity @s[nbt={BlockState:{Name:"minecraft:dragon_egg"}}] unless entity @s[nbt={BlockState:{Name:"minecraft:pointed_dripstone"}}] unless entity @s[nbt={BlockState:{Name:"minecraft:anvil"}}] unless entity @s[nbt={BlockState:{Name:"minecraft:chipped_anvil"}}] unless entity @s[nbt={BlockState:{Name:"minecraft:damaged_anvil"}}] run function cave_in:falling_block_main
...
execute as @e[type=armor_stand,tag=smoothing] at @s positioned ~ ~-250 ~ run function cave_in:smoothing/check_smooth
