...
execute as @s run summon item ~ ~-1 ~ {Item:{id:"minecraft:polished_deepslate",Count:1b}}

execute as @s[tag=spruce] run summon item ~ ~-1 ~ {Item:{id:"minecraft:stripped_spruce_log",Count:1b}}
execute as @s[tag=oak] run summon item ~ ~-1 ~ {Item:{id:"minecraft:stripped_oak_log",Count:1b}}
execute as @s[tag=dark_oak] run summon item ~ ~-1 ~ {Item:{id:"minecraft:stripped_dark_oak_log",Count:1b}}
execute as @s[tag=birch] run summon item ~ ~-1 ~ {Item:{id:"minecraft:stripped_birch_log",Count:1b}}
execute as @s[tag=jungle] run summon item ~ ~-1 ~ {Item:{id:"minecraft:stripped_jungle_log",Count:1b}}
execute as @s[tag=mangrove] run summon item ~ ~-1 ~ {Item:{id:"minecraft:stripped_mangrove_log",Count:1b}}
execute as @s[tag=cherry] run summon item ~ ~-1 ~ {Item:{id:"minecraft:stripped_cherry_log",Count:1b}}
execute as @s[tag=acacia] run summon item ~ ~-1 ~ {Item:{id:"minecraft:stripped_acacia_log",Count:1b}}
execute as @s[tag=warped] run summon item ~ ~-1 ~ {Item:{id:"minecraft:stripped_warped_stem",Count:1b}}
execute as @s[tag=crimson] run summon item ~ ~-1 ~ {Item:{id:"minecraft:stripped_crimson_stem",Count:1b}}
