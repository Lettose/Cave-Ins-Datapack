...
execute as @s[tag=cave_in,scores={cave_in.tick=1}] if score $global cave_in.massive_cavein_en matches 1 if score $global cave_in.massive_cavein_chance matches 4 run tag @s add massive_cave_in
execute as @s[tag=cave_in,scores={cave_in.tick=1}] if score $global cave_in.massive_cavein_en matches 1 if score $global cave_in.massive_cavein_chance matches 3 if predicate cave_in:massive_cavein_chance_high run tag @s add massive_cave_in
execute as @s[tag=cave_in,scores={cave_in.tick=1}] if score $global cave_in.massive_cavein_en matches 1 if score $global cave_in.massive_cavein_chance matches 2 if predicate cave_in:massive_cavein_chance_med run tag @s add massive_cave_in
execute as @s[tag=cave_in,scores={cave_in.tick=1}] if score $global cave_in.massive_cavein_en matches 1 if score $global cave_in.massive_cavein_chance matches 1 if predicate cave_in:massive_cavein_chance_low run tag @s add massive_cave_in
execute as @s[tag=cave_in,scores={cave_in.tick=1}] if score $global cave_in.massive_cavein_en matches 1 if score $global cave_in.massive_cavein_chance matches 0 if predicate cave_in:massive_cavein_chance_verylow run tag @s add massive_cave_in
