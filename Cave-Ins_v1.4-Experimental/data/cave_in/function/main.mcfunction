...
###### Cave In Mechanic ######
execute as @e[type=marker,tag=cave_in] at @s positioned ~ ~-250 ~ run function cave_in:cavein
execute as @e[type=marker,tag=additional_cave_in] at @s positioned ~ ~-250 ~ run function cave_in:cavein

execute as @e[type=marker,tag=massive_cave_in] at @s positioned ~ ~-250 ~ run function cave_in:massive_cavein
execute as @e[type=marker,tag=massive_additional_cave_in] at @s positioned ~ ~-250 ~ run function cave_in:massive_cavein



###### Supports ######
# Check Player Placed Polished Deepslate
execute if score $global cave_in.supports_en matches 1 as @a[scores={cave_in.place_player_head=1..}] at @s run function cave_in:ray/cast
# Build
execute if score $global cave_in.supports_en matches 1 as @e[type=marker,tag=build_support] at @s positioned ~ ~-251 ~ run function cave_in:supports/build_support
# Check Support
...
execute as @e[tag=random_cavein] run function cave_in:random_caveins/start_cavein
execute if score $global cave_in.random_cavein_timer matches 1 run function cave_in:random_caveins/y_level_check

execute if score $global cave_in.random_cavein_timer matches 60 run scoreboard players set $global cave_in.random_cavein_timer 0
