...
execute as @s[tag=highlight_ray] at @s align xyz positioned ~ ~250 ~ unless entity @e[tag=valid_support,distance=..12] at @s align xyz positioned ~0.5 ~ ~0.5 if block ~ ~ ~ #falling_blocks if block ~ ~-1 ~ #permeable if block ~ ~-2 ~ #permeable unless entity @e[tag=unsupported_particle,distance=..0.1] run summon area_effect_cloud ~ ~ ~ {Duration:10,Radius:0,WaitTime:0,Tags:["unsupported_particle"]}
execute as @s[tag=highlight_ray] at @s align xyz positioned ~ ~250 ~ if entity @e[tag=valid_support,distance=..12] at @s align xyz positioned ~0.5 ~ ~0.5 if block ~ ~ ~ #falling_blocks if block ~ ~-1 ~ #permeable if block ~ ~-2 ~ #permeable unless entity @e[tag=supported_particle,distance=..0.1] run summon area_effect_cloud ~ ~ ~ {Duration:10,Radius:0,WaitTime:0,Tags:["supported_particle"]}
