...
execute as @s[scores={cave_in.tick=4,cave_in.check_smoothing_count=..1}] positioned ~ ~ ~ if predicate cave_in:block_smoothing_chance run function cave_in:smoothing/replace_block/left
...
execute as @s[scores={cave_in.tick=6,cave_in.check_smoothing_count=..1}] positioned ~ ~ ~ if predicate cave_in:block_smoothing_chance run function cave_in:smoothing/replace_block/right
...
execute as @s[scores={cave_in.tick=8,cave_in.check_smoothing_count=..1}] positioned ~ ~ ~ if predicate cave_in:block_smoothing_chance run function cave_in:smoothing/replace_block/front
...
execute as @s[scores={cave_in.tick=10,cave_in.check_smoothing_count=..1}] positioned ~ ~ ~ if predicate cave_in:block_smoothing_chance run function cave_in:smoothing/replace_block/back

execute as @s[scores={cave_in.tick=11,cave_in.check_smoothing_count=..20}] run scoreboard players set @s cave_in.tick 0
